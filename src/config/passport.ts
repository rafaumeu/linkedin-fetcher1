...
if (!clientID || !clientSecret || !callbackURL) {
  throw new Error(
    "As variáveis de ambiente LINKEDIN_CLIENT_ID, LINKEDIN_CLIENT_SECRET e LINKEDIN_REDIRECT_URI devem estar definidas.",
  );
}
...
passport.use(
  new LinkedInStrategy(
    ...
    async (
      ...
      profile: Profile,
      done: (error: Error | null, user?: Profile | false) => void,
    ) => {
